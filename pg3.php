	...
	<section id="principal">
		...
		<div id="corpo">	
			...
			<div id="produtos">	
				...
				<!-- itens só aparecem no site desktop -->
				<div id="divItem">
					<?php itens()?>
				</div>
				
				<div id="titulo">
					<h2>Filmes em Promoção</h2>
				</div>
				
				<?php 	$sql = "select *,preco *(promoporcent/100) as totalDesc from tblfilme where promocao = 1";
					...
					<div class="caixasProdutos">
						<div class="conteudoProdutos">
							<img width="250px" height="275px" src="<?php echo($caminho.$rs['foto']);?>">
						</div>
						<div class="detalhesProdutos">
							<p>Nome: <?php echo($rs['nome']);?></p>
							<p>Genero: <?php echo($rs['genero']);?></p>
							<p>Preco: <?php echo($rs['preco'] - $rs['totalDesc']);?></p>
